//
//  RestoDetailsController.swift
//  RestroFinder
//
//  Created by Riya Alpeshkumar Mehta on 2021-08-07.
//  Copyright © 2021 Riya Alpeshkumar Mehta. All rights reserved.
//
...
class RestroDetailsViewController: AbstractViewController, UIScrollViewDelegate, MFMessageComposeViewControllerDelegate {
    ...
    class func control(with business: Businesses) -> RestroDetailsViewController {
        let control = self.control as! RestroDetailsViewController
...
//        guard let business = business else { return }
    ...
    @IBAction func mapBtnClicked(_ sender: Any) {
        self.navigationController?.pushViewController(MapViewController.controlWith(business: self.business!), animated: true)
    }
